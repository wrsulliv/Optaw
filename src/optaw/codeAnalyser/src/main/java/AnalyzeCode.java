...
public class AnalyzeCode {
	...
	public static String pathToEvals = "/home/costaspappus/Desktop/583FinalFiles/avg.txt";
	public static String pathToBenchmarks = "/home/costaspappus/Desktop/583FinalFiles/benchmarks/";
	public static String outputPath = "/home/costaspappus/Desktop/583FinalFiles/train.arff";
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println("Discovering best optimizations...");
        ...
        //<filename, execTime>
        HashMap<String, Double> execTimes = new HashMap<String, Double>();
        //classes set
        ...
        for(String line : lines){
        	...
        	classes.add(opt);
        	if(execTimes.containsKey(filename)){
        		Double prevBest = execTimes.get(filename);
        		if(time < prevBest){
            		opts.put(filename, opt);
            		execTimes.put(filename, time);
        		}
        	} else {
        		opts.put(filename, opt);
        		execTimes.put(filename, time);
        ...
        FileUtils.printArff(codeItems, opts, classes, outputDest);
