...
public class FileUtils {
     ...
     * @param outputDest
     */
    public static void printArff(List<CodeItem> codeItems, HashMap<String, Integer> opts, Set<Integer> classes, String outputDest){
        ...
        for (CodeItem item : codeItems) {
            result.append(item.getKeywordsFoundString()+","+opts.get(CodeUtils.removeEnding(item.getFileName())));
